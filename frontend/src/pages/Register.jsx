...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success(
        'Account created! Welcome to GlobeNest.'
      );
  ...
  return (
    <div className="auth-shell">
      ...
      <div className="auth-visual">
        ...
        <div className="content">
          <p className="quote">
            "Over 16 world destinations and hundreds of verified
            activities. Build, budget, and visualize your next
            dream trip effortlessly."
          </p>
      ...
      <div className="auth-form-side">
        ...
        >
          ...
          >
            Takes under a minute. Connects straight to your trip
            database.
          </p>
              ...
              {dropdownOpen && (
                <div
                  style={{
                    ...
                    background: '#fff',
                    border:
                      '1.5px solid var(--line, #e2e8f0)',
                    borderRadius: '10px',
                    boxShadow:
                      '0 12px 28px -4px rgba(0,0,0,0.12), 0 8px 12px -6px rgba(0,0,0,0.06)',
                    maxHeight: '190px',
                    overflowY: 'auto',
                    padding: '6px',
                  }}
